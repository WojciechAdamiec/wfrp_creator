...
def print_random_talents():
    for i in range(NUMBER_OF_RANDOM_TALENTS):
        print_random_talent(i + 1)


def print_random_talent(num=1):
...
class CharacterCreation:
    ...
    def handle_race_selection(self):
        ...
        # print(f"type: {type(selected_number)}, value: {selected_number}")
...
def main(used_talents: Annotated[str, typer.Option(help="Already used talents. Add then with commas.")] = ""):
    ...
    print_table_with_stats()
    print()
    remove_used_talents(used_talents)
    print()
    print_random_talents()
    print()
    print_starting_exp()
    print()
